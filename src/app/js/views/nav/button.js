    ...
    jade,Mustache,logger,config){
        ...
        var button = Backbone.View.extend({
            ...
            setButtonID : function(id){
                ...
                this.id = config.nav.button.suffix + this.counter++ + '__' + id;
   
                $(this.buttonEl).attr('id',this.id);
            ...
            setButtonClass : function(classname){
                ...
                $(this.buttonEl).attr('class',btn_class);
            ...
            drawButtonIcon : function(){
                ...
                this.icon.scale(2,2);
                this.iconglow = this.icon.glow({color:'#FFF'});
            ...
            bind : function(){
               ...
               logger.log($( this.buttonEl ),this.logcode);
               
               var that = this;
                
                $( this.buttonEl ).bind( "mousedown", function(event, ui) {

                    that.pressButton();
                
                });
                
                $( this.buttonEl ).bind( "mouseup", function(event, ui) {
